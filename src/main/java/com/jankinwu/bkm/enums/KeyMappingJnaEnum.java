...
public enum KeyMappingJnaEnum {
    ...
    MINUS((byte) 0xBD, "MINUS"),
    EQUALS((byte) 0xBB, "EQUALS"),
    OPEN_BRACKET((byte) 0xDB, "OPEN_BRACKET"),
    CLOSE_BRACKET((byte) 0xDD, "CLOSE_BRACKET"),
    BACKSLASH((byte) 0xDC, "BACKSLASH"),
    SEMICOLON((byte) 0xBA, "SEMICOLON"),
    QUOTE((byte) 0xDE, "QUOTE"),
    COMMA((byte) 0xBC, "COMMA"),
    PERIOD((byte) 0xBE, "PERIOD"),
    SLASH((byte) 0xBF, "SLASH"),
