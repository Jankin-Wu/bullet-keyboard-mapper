...
public enum KeyMappingEnum {
    ...
    public static Integer getEventCode(String key) {
        for (KeyMappingEnum keyMappingEnum : KeyMappingEnum.values()) {
            if (keyMappingEnum.getKey().equals(key)) {
                return keyMappingEnum.getEventCode();
            }
        }
        return null;
    }
